  ...
  let webpackConfig = {
    ...
    plugins: removeNil([
      ...
      new webpack.EnvironmentPlugin({
        ...
        // Date of build
        BUILD_DATE: new Date().toLocaleString().slice(0, -3),
      }),
      ...
      // HappyPack 'css' instance for client.
      ifElse(isClient || isServer)(
        happyPackPlugin({
          name: 'happypack-client-css',
          loaders: [
            {
              loader: 'css-loader',
              options: {
            ...
            ifElse(isClient || isServer)(
              mergeDeep(
                ...
                ifDevClient({
                  loaders: [
                    'style-loader',
                    'happypack/loader?id=happypack-client-css',
                    {
