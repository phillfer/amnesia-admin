...
import reducer from '../components/base/Ducks';
...
function configureStore(initialState) {
  ...
  if (process.env.NODE_ENV === 'development' && module.hot) {
    ...
    module.hot.accept('../components/base/Ducks', () => {
      const nextRootReducer = require('../components/base/Ducks').default; // eslint-disable-line global-require
