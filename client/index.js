...
import App from '../shared/components/base/App';
...
function renderApp(TheApp) {
  ...
  bootstrapper(app).then(() => hydrate(app, container));
}
...
if (process.env.BUILD_FLAG_IS_DEV === 'true' && module.hot) {
  ...
  module.hot.accept('../shared/components/base/App', () => {
    renderApp(require('../shared/components/base/App').default);
  });
}
